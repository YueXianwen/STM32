...
#define OLED_SCL  PAout(8)
#define OLED_SDA  PCout(13)
...
void OLED_ShowChinese(unsigned char x,unsigned char y,unsigned char no); //声明在指定位置显示汉字(16*16)函数
void OLED_ShowChinese_big(unsigned char x,unsigned char y,unsigned char no); //声明在指定位置显示汉字(24*24)函数
